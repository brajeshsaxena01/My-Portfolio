...
import logo from "../assets/boy.jpeg"

const lines = [
  "Hi, I'm Brajesh Saxena",
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-full gap-12 lg:gap-16 z-10">
        ...
        >
          ...
          >
            ...
            >
              <span className="gradient-text block">
                <TypingText text="Hi, I'm" delay={30} />
              </span>
              <span className="gradient-text-2 block mt-2">
                <TypingText text="Brajesh Saxena" delay={40} />
              </span>
            </motion.h1>
            ...
            >
              <p className="text-xl md:text-2xl text-purple-500 font-medium">
                <TypingText text="A Full Stack Web Developer" delay={10} />
              </p>
          ...
          >
            {[
              { icon: BsLinkedin, href: "https://www.linkedin.com/in/brajesh-saxena/", color: "hover:text-blue-400 hover:shadow-blue-500/25", bgColor: "hover:bg-blue-500/10", label: "LinkedIn" },
              { icon: BsGithub, href: "https://github.com/brajeshsaxena01", color: "hover:text-white hover:shadow-gray-500/25", bgColor: "hover:bg-gray-500/10", label: "GitHub" },
              // { icon: BsInstagram, href: "https://www.instagram.com/brajeshsaxena01", color: "hover:text-pink-400 hover:shadow-pink-500/25", bgColor: "hover:bg-pink-500/10", label: "Instagram" }
