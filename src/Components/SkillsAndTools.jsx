    ...
    return (
        ...
        >
            <div className="flex flex-col items-center space-y-4">
                ...
                <div className="text-center">
                    <h3 className=" text-lg md:text-xl lg:text-2xl font-bold text-white group-hover:text-indigo-300 transition-colors mb-1"
                        style={{ color: 'var(--black)' }}
                    >
                        {tool.name}
                    </h3>
                ...
                <div className="space-y-20">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <h3 className="text-3xl font-bold text-yellow-500">Technical Skills</h3>
                        </motion.div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <h3 className="text-3xl font-bold text-yellow-500">Development Tools</h3>
                        </motion.div>
