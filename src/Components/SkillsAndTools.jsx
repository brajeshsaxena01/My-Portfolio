    ...
    return (
        ...
        >
            <div className="flex flex-col items-center space-y-4">
                <div className={`p-4 rounded-2xl group-hover:scale-110 transition-transform duration-300 ${skill.name === "Flask" || skill.name === "Node.js" ? "themed-img" : ""}`}>
                    <img
                        src={skill.img}
                        alt={skill.name}
                ...
                <div className="text-center">
                    <h3 className="text-sm sm:text-xl font-bold text-white group-hover:text-indigo-300 transition-colors mb-1"
                        style={{ color: 'var(--black)' }}
                    >
                        {skill.name}
                    </h3>
    ...
    return (
        ...
        >
            <div className="flex flex-col items-center space-y-4">
                ...
                <div className="text-center">
                    <h3 className=" text-sm md:text-xl lg:text-2xl font-bold text-white group-hover:text-indigo-300 transition-colors mb-1"
                        style={{ color: 'var(--black)' }}
                    >
                        {tool.name}
                    </h3>
...
export const SkillsAndTools = () => {
    return (
        <section id="skills" className="py-0 md:-mt-72 lg:-mt-20 px-6 relative overflow-hidden">
            {/* Background Elements */}
                ...
                <div className="space-y-20">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <h3 className="text-xl sm:text-3xl font-bold text-yellow-500">Technical Skills</h3>
                        </motion.div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <h3 className="text-xl sm:text-3xl font-bold text-yellow-500">Development Tools</h3>
                        </motion.div>
